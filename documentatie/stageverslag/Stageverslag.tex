...
\begin{document}
	...
	\section{Context}
		...
		\subsection{Requirements}
			...
			\subsubsection{De kop van de machine moet over twee assen bewegen.}
				De kop van de machine moet over de x, y, z assen kunnen bewegen. (Functioneel) (MUST) \newline
				\textbf{Acceptatie:} De requirement is voltooid als de kop over de 3 assen heen en weer kan bewegen.
