...
\sffamily
	...
	\section{Test Rapport}
		...
		\subsection{De snij kop van de machine moet over de X, Y en Z as kunnen bewegen.}
			\paragraph{Acceptatiecriteria:}
				Deze test is voldaan als de kop van de machine kan bewegen over de drie bewegingsassen (x, y, z).

			\paragraph{Testopstelling}
				Deze test kan alleen op de machine worden uitgevoerd. Benodigd hiervoor is: 
				\begin{enumerate}
					\item Freesbank met de opstelling voor 3 assen
			...
			\paragraph{Instructies}
				\begin{enumerate}
					...
					\item Stuur een opdracht naar de machine via de serial monitor om over alle drie de assen te bewegen.
					\item Kijk of alle drie de assen bewegen.
				\end{enumerate}
			...
			\paragraph{Waarnemingen en conclusie}
				De freesbank beweegt zich over de drie assen naar het aangewezen punt en alle drie de assen komen tegelijker tijd aan op dat punt. Dus deze test is voldaan.

		\subsection{De positie van de snij kop op een as moet bepaald worden doormiddel van sensoren.}
			\paragraph{Acceptatiecriteria:}
				Deze test is voldaan als de locatie van de snij kop op een as te bepalen is doormiddel van een sensor.

			\paragraph{Testopstelling} 
				Deze test kan alleen op de machine worden uitgevoerd. Benodigd hiervoor is:
				\begin{enumerate}
					\item Freesbank met de opstelling van minimaal 1 as waaraan een sensor bevestigd is.
					\item Handleiding
				\end{enumerate}
			...
			\paragraph{Instructies}
				\begin{enumerate}
					\item Volg de handleiding om de machine aan te zetten.
					\item Indien nodig voeg de onderdelen voor de sensor toe aan de code.
					\item Stuur een opdracht naar de machine via de serial monitor om over de gekozen as te bewegen.
					\item Kijk of de as beweegt.
					\item Voer het commando uit om informatie op te vragen \((\$?)\) om te controleren of de sensor de beweging meet. 
				\end{enumerate}
			
			\paragraph{Verwacht resultaat}
				Het verwachte resulataat is dat de kop van de machine beweegt over de gekozen as, en dat de sensor de beweging meet.
			
			\paragraph{Waarnemingen en conclusie}
				De sensor meet de bewegingen over de as waar die aan vast zit. Dus deze test is voldaan.

		\subsection{Er kan g-code uitgevoerd worden door de freesbank.}
			\paragraph{Acceptatiecriteria:}
				Deze test is voldaan als de machine g-code kan uitvoeren.
			
			\paragraph{Testopstelling}
				Deze test kan alleen op de machine worden uitgevoerd. Benodigd hiervoor is:
				\begin{enumerate}
					\item Freesbank met de opstelling van minimaal 1 as.
					\item Handleiding
				\end{enumerate}
			...
			\paragraph{Instructies:}
				\begin{enumerate}
					\item Volg de handleiding om de machine aan te zetten.
					\item Stuur een opdracht naar de machine via de serial monitor. De opdrachten die gebruikt kunnen worden zijn te vinden in de handleiding.
					\item Controleer of de freesbank de opdracht uitvoert en een OK terug stuurt.
				\end{enumerate}

			\paragraph{Verwacht resultaat}
				Het verwachte resulaat is dat de machine de g-code uitvoert en een OK terug stuurt.

			\paragraph{Waarneming en conclusie}
				Als de machine de opdracht krijgt stuurt die 'OK' terug en daarna voert de machine de opdracht uit.
